pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/TibaAlMafrachi/225-lab3-8.git'  // GitHub repository containing Kubernetes YAML files
        KUBECONFIG = credentials('almafrtk-225-sp26')             // Jenkins stored credential for accessing your Kubernetes cluster
    }
